...
WebUI.click(findTestObject('Elearning/Page_Master Elearning  Elearning CMS/Branch Box PIC'))

WebUI.click(findTestObject('Elearning/Page_Master Elearning  Elearning CMS/Branch Button  PIC'))

WebUI.click(findTestObject('Elearning/Page_Master Elearning  Elearning CMS/Branch List PIC'))

WebUI.setText(findTestObject('Elearning/Page_Master Elearning  Elearning CMS/Branch Input PIC  Eric'), 'Eric')

WebUI.click(findTestObject('Elearning/Page_Master Elearning  Elearning CMS/Branch Eric Contana'), FailureHandling.STOP_ON_FAILURE)
